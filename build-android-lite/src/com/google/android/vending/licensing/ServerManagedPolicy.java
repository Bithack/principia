...
public class ServerManagedPolicy implements Policy {
    ...
    private static final String PREF_USERDATA = "userData";
    ...
    public ServerManagedPolicy(Context context, Obfuscator obfuscator) {
        ...
        mUserData = mPreferences.getString(PREF_USERDATA, "");
    ...
    public void processServerResponse(int response, ResponseData rawData) {
        ...
        Log.v("Principia", "processing server response");
    ...
    public void setUserData(String userdata)
    {
    	...
    	mUserData = sUserData;
    	mPreferences.putString(PREF_USERDATA, sUserData);
    }
    ...
    public void setSignature(String signature)
    {
    	...
    	mSignature = sSignature;
    	mPreferences.putString(PREF_SIGNATURE, sSignature);
    }
