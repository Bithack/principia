...
public class LicenseValidator {
	...
	public interface Listener {
		void onUpdate(String signature, String userdata);
		void onFailure();
	}
	
	public static void setListener(Listener l)
	{
		LicenseValidator.listener = l;
	}
	
    private static final String TAG = "Principia";
    ...
    public static void update(String signature, String userdata)
    {
    	
    	LicenseChecker.setSignature(signature);
    	LicenseChecker.setUserData(userdata);
    	
    	if (listener != null) {
    		listener.onUpdate(signature, userdata);
    	}
    }
