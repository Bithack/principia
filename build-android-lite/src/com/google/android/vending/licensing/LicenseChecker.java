...
public class LicenseChecker implements ServiceConnection {
    private static final String TAG = "PrincipiaLicenseChecker";
    ...
    public synchronized void checkAccess(LicenseCheckerCallback callback) {
        ...
        if (mPolicy.allowAccess()) {
            ...
            LicenseValidator.update(LicenseChecker.getSignature(), LicenseChecker.getUserData());
        } else {
    ...
    {
    	ServerManagedPolicy smp = (ServerManagedPolicy)mPolicy;
    	smp.setUserData(userdata);
    }
    
    public static String getUserData()
    {
    	ServerManagedPolicy smp = (ServerManagedPolicy)mPolicy;
    	return smp.getUserData();
    }
    
    public static void setSignature(String signature)
    {
    	ServerManagedPolicy smp = (ServerManagedPolicy)mPolicy;
    	smp.setSignature(signature);
    }
    
    public static String getSignature()
    {
    	ServerManagedPolicy smp = (ServerManagedPolicy)mPolicy;
    	return smp.getSignature();
    }
