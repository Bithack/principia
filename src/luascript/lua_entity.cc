...
static int l_entity_set_angle(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:set_angle", "1.5.1", LEVEL_VERSION_1_5_1);
...
static int l_entity_set_fixed_rotation(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:set_fixed_rotation", "1.5.1", LEVEL_VERSION_1_5_1);
...
static int l_entity_is_fixed_rotation(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:is_fixed_rotation", "1.5.1", LEVEL_VERSION_1_5_1);
...
static int l_entity_get_layer(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:get_layer", "1.4", LEVEL_VERSION_1_4);
    entity *e = *(static_cast<entity**>(luaL_checkudata(L, 1, "EntityMT")));
...
static int l_entity_local_to_world(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:local_to_world", "1.4", LEVEL_VERSION_1_4);
    entity *e = *(static_cast<entity**>(luaL_checkudata(L, 1, "EntityMT")));
...
static int l_entity_world_to_local(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:world_to_local", "1.4", LEVEL_VERSION_1_4);
    entity *e = *(static_cast<entity**>(luaL_checkudata(L, 1, "EntityMT")));
...
static int l_entity_highlight(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:highlight", "1.4", LEVEL_VERSION_1_4);
    entity *e = *(static_cast<entity**>(luaL_checkudata(L, 1, "EntityMT")));
...
static int l_entity_damage(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:damage", "1.5", LEVEL_VERSION_1_5);
...
static int l_entity_is_static(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:is_static", "1.5", LEVEL_VERSION_1_5);
...
static int l_entity_absorb(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:absorb", "1.5", LEVEL_VERSION_1_5);
...
static int l_entity_apply_torque(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:apply_torque", "1.5", LEVEL_VERSION_1_5);
...
static int l_entity_apply_force(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:apply_force", "1.5.1", LEVEL_VERSION_1_5_1);
...
static int l_entity_set_velocity(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:set_velocity", "1.5", LEVEL_VERSION_1_5);
...
static int l_entity_warp(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:warp", "1.5", LEVEL_VERSION_1_5);
...
static int l_entity_show(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:show", "1.5", LEVEL_VERSION_1_5);
...
static int l_entity_hide(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:hide", "1.5", LEVEL_VERSION_1_5);
...
static int l_entity_is_hidden(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:is_hidden", "1.5.1", LEVEL_VERSION_1_5_1);
...
static int l_entity_get_name(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:get_name", "1.5", LEVEL_VERSION_1_5);
...
static int l_entity_is_creature(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:is_creature", "1.5", LEVEL_VERSION_1_5);
...
static int l_entity_is_robot(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:is_robot", "1.5", LEVEL_VERSION_1_5);
...
static int l_entity_is_player(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:is_player", "1.5", LEVEL_VERSION_1_5);
...
static int l_entity_get_mass(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:get_mass", "1.5", LEVEL_VERSION_1_5);
...
static int l_entity_get_density(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:get_density", "1.5", LEVEL_VERSION_1_5);
...
static int l_entity_get_friction(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:get_friction", "1.5", LEVEL_VERSION_1_5);
...
static int l_entity_get_restitution(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:get_restitution", "1.5", LEVEL_VERSION_1_5);
...
static int l_entity_set_color(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:set_color", "1.5", LEVEL_VERSION_1_5);
...
static int l_entity_get_color(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:get_color", "1.5", LEVEL_VERSION_1_5);
...
static int l_entity_disconnect_all(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:disconnect_all", "1.5", LEVEL_VERSION_1_5);
...
static int l_entity_set_target_id(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:set_target_id", "1.5", LEVEL_VERSION_1_5);
...
static int l_creature_get_hp(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "creature:get_hp", "1.5", LEVEL_VERSION_1_5);
...
static int l_creature_get_armor(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "creature:get_armor", "1.5", LEVEL_VERSION_1_5);
...
static int l_creature_get_aim(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "creature:get_aim", "1.5", LEVEL_VERSION_1_5);
...
static int l_creature_set_aim(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "creature:set_aim", "1.5", LEVEL_VERSION_1_5);
...
static int l_creature_stop(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "creature:stop", "1.5", LEVEL_VERSION_1_5);
...
static int l_creature_move(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "creature:move", "1.5", LEVEL_VERSION_1_5);
...
static int l_creature_is_action_active(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "creature:is_action_active", "1.5", LEVEL_VERSION_1_5);
...
static int l_creature_action_on(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "creature:action_on", "1.5", LEVEL_VERSION_1_5);
...
static int l_creature_action_off(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "creature:action_off", "1.5", LEVEL_VERSION_1_5);
...
/* luascript specific functions */

/* entity:call(functionname) */
static int l_luascript_call(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "entity:call", "1.5", LEVEL_VERSION_1_5);

    entity *ent = *(static_cast<entity**>(luaL_checkudata(L, 1, "EntityMT")));

    if (ent->g_id != O_LUASCRIPT) {
    ...
    luascript *e = static_cast<luascript*>(ent);
...
#undef LUA_REG
    ...
    /* luascript specific stuff */
    {"call", l_luascript_call},
