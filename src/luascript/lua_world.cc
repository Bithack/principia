...
static int l_world_get_entity(lua_State *L) {
    ...
    if (e) {
        ...
        *(ee) = e;
        ...
        //luascript *es = static_cast<luascript*>(L->userdata);
...
static int l_world_raycast(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "world:raycast", "1.4", LEVEL_VERSION_1_4);
...
static int l_world_query(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "world:query", "1.4", LEVEL_VERSION_1_4);
    float x1 = luaL_checknumber(L, 2);
    float y1 = luaL_checknumber(L, 3);
    float x2 = luaL_checknumber(L, 4);
    float y2 = luaL_checknumber(L, 5);
...
static int l_world_get_gravity(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "world:get_gravity", "1.4", LEVEL_VERSION_1_4);
...
static int l_world_set_gravity(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "world:set_gravity", "1.5.1", LEVEL_VERSION_1_5_1);
...
static int l_world_get_adventure_id(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "world:get_adventure_id", "1.5", LEVEL_VERSION_1_5);
...
static int l_world_get_borders(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "world:get_borders", "1.5", LEVEL_VERSION_1_5);
...
static int l_world_get_world_point(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "world:get_world_point", "1.5", LEVEL_VERSION_1_5);
...
static int l_world_get_screen_point(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "world:get_screen_point", "1.5", LEVEL_VERSION_1_5);
...
static int l_world_set_bg_color(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "world:set_bg_color", "1.5", LEVEL_VERSION_1_5);
...
static int l_world_set_ambient_light(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "world:set_ambient_light", "1.5", LEVEL_VERSION_1_5);
...
static int l_world_set_diffuse_light(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "world:set_diffuse_light", "1.5", LEVEL_VERSION_1_5);
