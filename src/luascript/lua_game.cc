...
static int l_game_finish(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "game:finish", "1.3.0.2", LEVEL_VERSION_1_3_0_2);
...
static int l_game_add_score(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "game:add_score", "1.3.0.2", LEVEL_VERSION_1_3_0_2);
...
static int l_game_set_score(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "game:set_score", "1.3.0.2", LEVEL_VERSION_1_3_0_2);
...
static int l_game_get_score(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "game:get_score", "1.3.0.2", LEVEL_VERSION_1_3_0_2);
...
static int l_game_activate_rc(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "game:activate_rc", "1.3.0.2", LEVEL_VERSION_1_3_0_2);
...
static int l_game_activate_rc_by_id(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "game:activate_rc_by_id", "1.3.0.2", LEVEL_VERSION_1_3_0_2);
...
static int l_game_message(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "game:message", "1.4", LEVEL_VERSION_1_4);
...
static int l_game_get_cursor(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "game:get_cursor", "1.4", LEVEL_VERSION_1_4);
...
static int l_game_poll_event(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "game:poll_event", "1.4", LEVEL_VERSION_1_4);
    ...
    lua_pushboolean(L, current_luascript->events[ev] > 0);
    return 1;
}

/* local x, y = game:get_screen_cursor() */
static int l_game_get_screen_cursor(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "game:get_screen_cursor", "1.5", LEVEL_VERSION_1_5);
...
static int l_game_restart(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "game:restart", "1.5", LEVEL_VERSION_1_5);
...
static int l_game_submit_score(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "game:submit_score", "1.5", LEVEL_VERSION_1_5);
...
static int l_game_set_variable(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "game:set_variable", "1.5", LEVEL_VERSION_1_5);
...
static int l_game_get_variable(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "game:get_variable", "1.5", LEVEL_VERSION_1_5);
...
static int l_game_get_fps(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "game:get_fps", "1.5", LEVEL_VERSION_1_5);
...
static int l_game_prompt(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "game:prompt", "1.5.1", LEVEL_VERSION_1_5_1);

    luascript *self = static_cast<luascript*>(L->userdata);
