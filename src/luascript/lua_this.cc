...
static int l_this_write(lua_State *L) {
    luascript *e = *(static_cast<luascript**>(luaL_checkudata(L, 1, "This")));
...
static int l_this_has_plug(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:has_plug", "1.5", LEVEL_VERSION_1_5);
...
static int l_this_write_frequency(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:write_frequency", "1.3.0.2", LEVEL_VERSION_1_3_0_2);
...
static int l_this_listen_on_frequency(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:listen_on_frequency", "1.4", LEVEL_VERSION_1_4);
...
static int l_this_first_run(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:first_run", "1.3.0.2", LEVEL_VERSION_1_3_0_2);
    LUASCRIPT_FUNCTION_DEPRECATED(L, "this:first_run", "1.5", LEVEL_VERSION_1_5);
...
static int l_this_get_position(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:get_position", "1.3.0.2", LEVEL_VERSION_1_3_0_2);
...
static int l_this_get_id(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:get_id", "1.5", LEVEL_VERSION_1_5);
...
static int l_this_get_resolution(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:get_resolution", "1.5", LEVEL_VERSION_1_5);
...
static int l_this_get_ratio(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:get_ratio", "1.5", LEVEL_VERSION_1_5);
...
static int l_this_set_sprite_blending(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:set_sprite_blending", "1.3.0.2", LEVEL_VERSION_1_3_0_2);
...
static int l_this_set_sprite_filtering(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:set_sprite_filtering", "1.3.0.2", LEVEL_VERSION_1_3_0_2);
...
static int l_this_set_sprite_texel(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:set_sprite_texel", "1.3.0.2", LEVEL_VERSION_1_3_0_2);
...
static int l_this_clear_texels(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:clear_texels", "1.4", LEVEL_VERSION_1_4);
...
static int l_this_set_draw_tint(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:set_draw_tint", "1.3.0.2", LEVEL_VERSION_1_3_0_2);
...
static int l_this_set_draw_z(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:set_draw_z", "1.3.0.2", LEVEL_VERSION_1_3_0_2);
...
static int l_this_set_draw_coordinates(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:set_draw_coordinates", "1.5", LEVEL_VERSION_1_5);
    ...
    if (mode < 0 || mode > 2) {
        ...
        if (e->coordinate_mode == LUASCRIPT_LOCAL && lua_gettop(L) == 3) {
...
static int l_this_draw_sprite(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:draw_sprite", "1.3.0.2", LEVEL_VERSION_1_3_0_2);
    ...
    if (draw->sprite_count < MAX_SPRITES) {
        ...
        if (e->coordinate_mode == LUASCRIPT_LOCAL) {
...
static int l_this_draw_line(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:draw_line", "1.4", LEVEL_VERSION_1_4);
...
static int l_this_draw_gradient_line(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:draw_gradient_line", "1.5", LEVEL_VERSION_1_5);
...
static int l_this_draw_line_3d(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:draw_line_3d", "1.5", LEVEL_VERSION_1_5);
...
static int l_this_draw_gradient_line_3d(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:draw_gradient_line_3d", "1.5", LEVEL_VERSION_1_5);
...
static int l_this_get_sprite_texel(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:get_sprite_texel", "1.5", LEVEL_VERSION_1_5);
...
static int l_this_init_draw(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:init_draw", "1.5", LEVEL_VERSION_1_5);
...
static int l_this_set_static_sprite_texel(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:set_static_sprite_texel", "1.5", LEVEL_VERSION_1_5);
...
static int l_this_clear_static_texels(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:clear_static_texels", "1.5", LEVEL_VERSION_1_5);
...
static int l_this_add_static_sprite(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:add_static_sprite", "1.5", LEVEL_VERSION_1_5);
...
static int l_this_clear_static_sprites(lua_State *L) {
    LUASCRIPT_VERSION_ERROR(L, "this:clear_static_sprites", "1.5", LEVEL_VERSION_1_5);
...
void register_this(lua_State *L, luascript *e) {
    ...
    luascript **ee = static_cast<luascript**>(lua_newuserdata(L, sizeof(entity*)));
    *(ee) = e;
