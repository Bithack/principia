...
const char * LIB_PATH_VALUE   = "C:\\dev\\mingw\\msys\\1.0\\home\\pajlada\\git\\principia\\src\\jpeg\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:\\dev\\mingw\\msys\\1.0\\home\\pajlada\\git\\principia\\src\\jpeg\\.libs;C:\\dev\\mingw\\lib;C:\\dev\\mingw\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    PATH=/home/pajlada/git/principia/src/jpeg/.libs:/mingw/lib:/mingw/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/home/pajlada/git/principia/src/jpeg/.libs:$PATH\"\n", f);
  fputs ("\n", f);
