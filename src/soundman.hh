...
/**
 * Class representing the Sound Manager object.
 *
 * Player Wiki ref: https://principia-web.se/wiki/Sound_Manager
 */
class soundman : public i1o1gate {
  private:
    float volume;
    /// Do not state save the busy variable, no sounds will be playing on
    /// state load or open of a level
    bool busy;
