...
*/
void __rotozoomSurfaceSizeTrig(int width, int height, double angle, double zoomx, double zoomy, 
	...
	if (fabs(angle) > VALUE_LIMIT) {
		...
		*/
		if (is32bit) {
			...
			*/
			___transformSurfaceRGBA(rz_src, rz_dst, dstwidthhalf, dstheighthalf,
			...
			*/
			_transformSurfaceY(rz_src, rz_dst, dstwidthhalf, dstheighthalf,
				(int) (sanglezoominv), (int) (canglezoominv),
				flipx, flipy);
		}
		/*
