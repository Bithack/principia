...
float Android_ScreenDensityX = 0;
float Android_ScreenDensityY = 0;
...
void
Android_SetScreenResolution(int width, int height, Uint32 format, float density_x, float density_y)
{
    Android_ScreenWidth = width;
    Android_ScreenHeight = height;   
    Android_ScreenFormat = format;
    Android_ScreenDensityX = density_x;
    Android_ScreenDensityY = density_y;
