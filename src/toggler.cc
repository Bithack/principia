...
void toggler::on_slider_change(int s, float v) {
    this->properties[0].v.i8 = (int)roundf(v);
    this->value = (this->properties[0].v.i8 > 0);
    G->show_numfeed(v);
}

float toggler::get_slider_value(int s) {
