...
void minibot::on_load(bool created, bool has_state) {
...
bool minibot::roam_can_target(entity *e, bool must_see) {
...
void minibot::roam_set_target_type() {
