...
/**
 * Class representing the Laser object.
 *
 * Player Wiki ref: https://principia-web.se/wiki/Laser
 */
...
/**
 * Class representing the Laser Bouncer object.
 *
 * Player Wiki ref: https://principia-web.se/wiki/Laser_Bouncer
 */
...
/**
 * Class representing the Laser Sensor object.
 *
 * Player Wiki ref: https://principia-web.se/wiki/Laser_Sensor
 */
class laser_sensor : public ecomp_simpleconnect {
  public:
    ...
    void write_quickinfo(char *out) {
        sprintf(out, "%s (wavelength: %.1f)", this->get_name(), this->properties[0].v.f);
    }
    ...
    float get_slider_value(int s) {
        if (s == 0)
            ...
            return (float)this->properties[1].v.i;
    }
    void on_slider_change(int s, float value);
};
