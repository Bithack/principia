...
game_graph::game_graph(const char *_name) : name(_name), max_data_points(100), interval(0.5), timer(0.0) { }

void game_graph::recalculate() {
...
void game_graph::reset() {
    this->timer = 0.0;

    this->data.clear();
}

void game_graph::set_size(float width, float height) {
    this->width = width;
    this->height = height;
}

void game_graph::set_position(float x, float y) {
    this->x = x;
    this->y = y;
}

void game_graph::set_interval(double interval) {
    this->interval = interval;
}

void game_graph::set_max_data_points(uint16_t max_data_points) {
    this->max_data_points = max_data_points;
}

void game_graph::set_min(double min) {
    this->min = min;
}

void game_graph::push(double dt, double val) {
...
void game_graph::render(pscreen *host) const {
...
const std::deque<double> &game_graph::get_data() const {
    return this->data;
}
